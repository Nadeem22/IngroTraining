...
<ul>
    ...
    <li><a class="av" href="${pageContext.request.contextPath}/showTrainList">Update Train</a></li>
...
<div id="form">
   ...
   <table>
    ...
    <!-- Printing all trains -->
    <c:forEach var="tempTrain" items="${trainList}">
    
    <c:url var="updateLink" value="/showFormForUpdate">
    <c:param name="trainId" value="${tempTrain.trainId}"></c:param>
    </c:url>
    
        <tr>
        <td ><a href="${updateLink}">${tempTrain.trainName}</a></td> 
        </tr>
    </c:forEach>
